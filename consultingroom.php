...
<body>
    <!--SIDE NAVE BAR-->
    <!-- navbar -->
     <?php include("consultingnavbar.php") ?>
     
<!--login form-->
    <div class="container" id="registration">
        <header>Patient Consultation</header>
        ...
        <form action="consultingroomsubmit.php" method="POST">
            <div class="form first">
                ...
                <div class="details ID"> 
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Address</label>
                            <input type="text" placeholder="e.g Bubuashie" name = "address" id = "address" required>
                        </div>
                        <div class="input-field">
                        <label>Gender</label>
            ...
            <div class="form second">
                <div class="details address">
                    ...
                    <div class="input-field">
                        <label>Status of Additional Diagnosis</label>
