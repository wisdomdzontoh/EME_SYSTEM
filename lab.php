...
<!--login form-->
    <div class="container" id="registration">
        <header>LABORATORY TESTS</header>
            ...
            <div class="form second">
                <div class="details address">
                    ...
                    <div class="fields">
                        ...
                        <input type="tel" placeholder="e.g John Smith" name="nameOfPrescriber" id="nameOfPrescriber" required>
                    </div>
                    <div class="input-field">
                        <label>Phone of prescriber</label>
                        <input type="text" placeholder="e.g 0245380035" name="phoneOfPrescriber" id="phoneOfPrescriber" >
                    </div>
                    <div class="input-field">
                        <label>Provisional Diagnosis</label>
                        <input type="text" placeholder="e.g Uncomplicated Malaria" name="Provisional" id="Provisional" readonly required>
                    </div>
                    <div class="input-field">
                        <label>Date of sample collection</label>
                        <input type="date"  name = "dateSampleCollection" required>
                    </div>
                    <div class="input-field">
                        <label>Time of sample collection</label>
                        <input type="time"  name = "timeSampleCollection" required>
                    </div>
                    <div class="input-field">
